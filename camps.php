...
<div style="height:100%; width:100%; margin:auto; background-color:#f8f1e4; border:2px solid red; box-shadow:4px 1px 20px black;">
    <div class="s_bg">
<div class="wrap">
<div class="main_cont">
     <div class="main">
...
$s="select * from camp,state,city where camp.state=state.state_id and camp.city=city.city_id";
    ...
    <table cellpadding="0" cellspacing="0" class="tableborder" width="500" height="500"style="border:none">
