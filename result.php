...
<div style=" height:auto">
  ...
  <table cellpadding="0" cellspacing="0" width="800px" height="100px" style="margin:auto; border:0px" class="tableborder">
        ...
        <tr><td >&nbsp;</td></tr> 
            ...
            <?php
$cn=makeconnection();
$s="select * from donors,bloodgroup where donors.b_id='". $_REQUEST["bg"]."' and donors.b_id=bloodgroup.bg_id";
...
?>
  <tr><td  >
            ...
            <table cellpadding="0" cellspacing="0" width="1000px" height="100px" style="margin:auto; border:none;" class="tableborder">


                <tr><td width="100px"  align="center" style="vertical-align:middle">

 <a href="Admin/doner_pic<?php echo $data[8] ?>"data-lightbox="image-1"> <img src="Admin/doner_pic/<?php echo $data[8] ?>" height="100px" width="100px" style="margin:auto; padding-left:70px; padding-right:50px; float:left" /></a></td>
