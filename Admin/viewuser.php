...
<div style=" height:auto">
 ...
 <table cellpadding="0" cellspacing="0" width="800px" height="100px" style="margin:auto; border:0px" class="tableborder">
       <tr><td  align="center"><img src="Images/donor1.png" height="80px" style="padding-top:20px" /></td></tr>
       <tr><td >&nbsp;</td></tr> 
         
           <?php
$cn=makeconnection();
$s="select * from donors,bloodgroup where  donors.b_id=bloodgroup.bg_id";
...
?>
  <tr><td  >
            ...
            <table cellpadding="0" cellspacing="0" width="100px" height="100px" style="margin:auto; border:none;" class="tableborder">
 ...
 <a href="doner_pic<?php echo $data[8] ?>"data-lightbox="image-1"> <img src="doner_pic/<?php echo $data[8] ?>" height="100px" width="100px" style="margin:auto; padding-left:70px; padding-right:50px; float:left" /></a></td>
                    ...
                    <td width="1000px" height="100px" style="vertical-align:top;">
                        

                        <table cellpadding="0" width="800px" height="150px" style="border:none; margin-left:20%;">
