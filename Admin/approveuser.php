...
<table>
  <tr>
    ...
    <th style='text-align: center;'>Medical Certificate</th>
    <th style='text-align: center;'>Approve</th>
    <th style='text-align: center;'>Reject</th>
  </tr>
<?php
$cn=mysqli_connect("localhost","root","","bloodbank");
$s="select * from donarregistration, bloodgroup where donarregistration.b_id=bloodgroup.bg_id ";
	...
	while($data=mysqli_fetch_array($result))
	{
            ...
            <td style='text-align: center; height: 50px;'>$data[11]</td>
            <td style='text-align: center; height: 50px;'>$data[6]</td>
            <td style='text-align: center; height: 50px;'><button onclick='openPHPFile($data[0])' >View</button></td>
            <td style='text-align: center; height: 50px;'><button onclick='openPHPPdf($data[0])' >View</button></td>
...
?>
<script>
  function openPHPFile(userId) {
    var url = "get_profile_pic.php?userid=" + userId;
    window.open(url);
  }
</script>
<script>
  function openPHPPdf(useId) {
    var url = "get_pdf.php?useid=" + useId;
    window.open(url);
  }
</script>
<script>
  function approveRd(useId) {
    var url = "approve.php?useid=" + useId;
    window.open(url);
  }
</script>
<script>
  function rejectRd(useId) {
    var url = "rejected.php?useid=" + useId;
    window.open(url);
  }
</script>
</body>
